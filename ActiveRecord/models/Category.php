...
class Category extends Model 
{
     ...
     */
    static $table_name='guns_xa_categories';
    ...
    */
    static $before_save = array("check_alias", "check_active");

    public function check_alias() {

        if(empty($this->alias)) { $this->alias = $this->category; }
    ...
    public function check_active() {
        ...
        if(empty($this->active)) { $this->active = "0"; }
